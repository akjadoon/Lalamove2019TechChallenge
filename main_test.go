...
func TestLatestVersions(t *testing.T) {
	testCases := []struct {
		...
		{
			versionSlice:   []string{"1.8.11", "1.9.6", "1.9.5", "1.8.10", "1.7.14", "1.8.9", "1.9.5"},
			expectedResult: []string{""},
			minVersion:     semver.New("1.10.1"),
		},
		{
			versionSlice:   []string{"1.8.0","1.8.2","1.8.3", "1.9.5","1.9.6", "1.10.0", "2.1.6","2.2.8"},
			expectedResult: []string{"1.10.0"},
			minVersion:     semver.New("1.10.0"),
		},
